"""
Django settings for jaynkey_42010 project.
...
ROOT_URLCONF = 'jaynkey_42010.urls'
...
WSGI_APPLICATION = 'jaynkey_42010.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jaynkey_42010 API",
    "DESCRIPTION": "API documentation for jaynkey_42010 App",
    "VERSION": "v1",
}
